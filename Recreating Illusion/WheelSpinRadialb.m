% Script Name:  WheelSpinRadialb.m
...
% form. Version 2.0 is made to separate edge from inside (wheel) contrast... 

function    WheelStimMat = WheelSpinRadialb(ImSiz, numSeg, radVec, edgePropSz, baseGry, nFrames, radSpd, dir)
